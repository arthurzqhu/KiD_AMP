...
zctrl=${ztop} !zctrl(1) is the domain height, (2) and (3) specify the location to init. hydromets.
rhctrl=${rh}
/
...
/
END
     ./bin/KiD_CU_2D.exe namelists/jobnml/${mconfig}_${ampORbin[$iab]}_${bintype[$ibt]}_${var1str}_${var2str}.nml
#            done
#          done
#        done
#      done
