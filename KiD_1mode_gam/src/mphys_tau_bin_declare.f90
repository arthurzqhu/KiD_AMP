...
!
!*COMDECK SDOLD
COMMON/SDOLD/ANKOLD,AMKOLD,AMKORIG,ANKORIG,CCNOLD,AMKPROC,ANKPROC
...
!ANKOLD and AMKOLD are updated after activation
 ...
 REAL,DIMENSION(JMINP:JMAXP,KKP,LK):: AMKPROC 
 REAL,DIMENSION(JMINP:JMAXP,KKP,LK):: ANKPROC
 ! AMKPROC and ANKPROC are updated after the completion of the 
 ! previous microphysical process to calculate the rate of individual proc
...
!*COMDECK SEDIM
 ...
 COMMON/SEDIM/AMS,VT,VBAR, QL_SED, QLN_SED, QLX_SED, VBAR_MOM
 REAL,DIMENSION(JMINP:JMAXP,KKP):: AMS,VT,VBAR
 REAL, DIMENSION(JMINP:JMAXP,KKP,LK) :: QL_SED
 REAL, DIMENSION(JMINP:JMAXP,KKP,LK) :: QLN_SED
 REAL, DIMENSION(JMINP:JMAXP,KKP,LK,10) :: QLX_SED
 REAL, DIMENSION(JMINP:JMAXP,KKP,10) :: VBAR_MOM
!*COMDECK NUCFACT
