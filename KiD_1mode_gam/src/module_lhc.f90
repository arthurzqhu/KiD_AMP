...
subroutine write_lhc_nc(param_dim, sample_dim)
!*****************************************************************************80
!
...
!
  ...
  integer ( kind = 4 ), intent(in) :: param_dim
  integer ( kind = 4 ), intent(in) :: sample_dim
...
!
  ...
  ! stop 0
end subroutine write_lhc_nc

end module module_lhc
