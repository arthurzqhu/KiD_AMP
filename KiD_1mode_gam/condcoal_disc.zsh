...
# config of the run
mps=("BIN_TAU")
config_name="condcoal_dt5"
caselist=(101) #(101 102 103 105 106 107)
case_num=${#caselist[@]}

KiD_path="/home/arthurhu/KiD_AMP/KiD_1mode_gam/"
param_val_fpath="/home/arthurhu/Cloud_BOSS/param_consolid_simPL_coal3069_hill_growth_updated_coal_4ma_hill_growth_r1.csv"
...
[ $l_noevap_s -eq 1 ] && l_noevap_f='.true.' || l_noevap_f='.false.'
